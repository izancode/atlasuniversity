...
//   setTheme(isDark?'dark':'light')
 ...
 return (
   ...
   <label className='group w-[60px] h-[30px] block relative  bg-white-950 rounded-[200px] shadow-[inset_0px_5px_15px_rgba(0,0,0,0.4),inset_0px_-5px_15px_rgba(255,255,255,0.2)] cursor-custom transition-all duration-300
